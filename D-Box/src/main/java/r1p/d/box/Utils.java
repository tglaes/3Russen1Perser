...
public class Utils {
	...
	// Mahan
	public static final String PROJECT_PATH = "C:\\Users\\Mahan\\git\\3Russen1Perser\\";
	//public static final String DATABASE_PATH = PROJECT_PATH + "D-Box\\src\\main\\data\\Database\\DBoxDB.db";
	// Vadim
	// Iurie
	...
	public static DocumentType IntToDocumentType(int type) {
		...
		switch (type) {
		case 0:
			docType = DocumentType.Shared;
			break;
		case 1:
			docType = DocumentType.Private;
			break;
		case 2:
			docType = DocumentType.Public;
			break;
		case 3:
			docType = DocumentType.Normal;
			break;
		default:
			docType = null;
			break;
